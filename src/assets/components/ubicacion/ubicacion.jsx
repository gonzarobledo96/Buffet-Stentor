function Ubicacion() {
    ...
    return (
        <div id="ubicacion" >
         <div className="fondo-contactar">
         <h1 className="text-center text-black texto-fondo-contactar tamaño-1-media-cuire"><b>UBICACION</b></h1>
        ...
        <div className="row row-cols-12  mt-3">{/* row-cols-md-2  */}
            <iframe
